...
struct PositionAnalysis: Codable {
    let mobility: [Player: Int]          // Number of moves for each player
    let cornerControl: [Player: Int]     // Number of corners controlled
    let edgeControl: [Player: Int]       // Number of edge pieces
    let stability: [Player: Double]      // Piece stability score
