...
public struct Board: Hashable, Codable {
    ...
    public func placing(_ state: CellState, at position: BoardPosition) -> Board {
    ...
    public func placing(_ placements: [BoardPosition: CellState]) -> Board {
        var newCells = cells
    ...
    public var allPositions: [BoardPosition] {
    ...
    public func positions(with state: CellState) -> [BoardPosition] {
    ...
    public func capturedPositions(placing player: Player, at position: BoardPosition) -> [BoardPosition] {
    ...
    public func isValidMove(at position: BoardPosition, for player: Player) -> Bool {
    ...
    public func validMoves(for player: Player) -> [BoardPosition] {
    ...
    public func applyingMove(_ move: Move) -> (board: Board, captured: [BoardPosition])? {
